...
export default class Selectbox extends React.Component {
    ...
    _renderChildren() {
        ...
        return <View style={styles.selectStyle}>
            <View style={styles.selectContainerStyle}>
                <Text
                    style={[styles.selectLabelStyle, this.props.selectLabelStyle]}>{this.props.selectedItem.label + ''}</Text>
    ...
    render() {
        const modal = (
            <Modal transparent={this.props.transparent} ref="modal" visible={this.state.modalVisible}
